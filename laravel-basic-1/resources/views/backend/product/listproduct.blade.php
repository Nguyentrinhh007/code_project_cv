						...
						<div class="bootstrap-table">
							<div class="table-responsive">
								...
								<div class="alert bg-danger" role="alert">
									<svg class="glyph stroked checkmark">
										<use xlink:href="#stroked-checkmark"></use>
									</svg>{{ session('thongbao2') }}<a href="#" class="pull-right"><span class="glyphicon glyphicon-remove"></span></a>
								</div>
								@endif
								...
								<table class="table table-bordered" style="margin-top:20px;">
									...
									<tr>
										...
										<td>
											<div class="row">
												<div class="col-md-3"><img src="/backend/img/{{ $row->img }}" alt="Áo đẹp" width="100px" class="thumbnail"></div>
												<div class="col-md-9">
										...
										<td>
											...
											<a onclick="return del_product()" href="/admin/product/del/{{ $row->id }}" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
										</td>
									</tr>
									@endforeach
									</tbody>
...
@section('script')
	...
	<script>
		...
		{
			return confirm('Bạn muốn xóa sản phẩm nay?')
		}
	</script>
@endsection