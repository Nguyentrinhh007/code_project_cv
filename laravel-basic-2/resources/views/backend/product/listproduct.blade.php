									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<a onclick="return del_product()" href="admin/product/del/{{ $product->id }}" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i> Xóa</a>
											</td>
										</tr>
										@endforeach
									</tbody>
...
@section('script')
	...
	<script>
		...
		{
			return confirm('Bạn có muốn xóa hay không ?')
		}
	</script>
@endsection
