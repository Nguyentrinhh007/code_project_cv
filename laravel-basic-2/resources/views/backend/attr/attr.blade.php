					...
					<div class="panel-body">
						...
						<div class="row magrin-attr">
							<div class="col-md-2 panel-blue widget-left">
								...
								<a onclick="return del_attr('{{ $attr->name }}')" class="delete-attr" href="admin/product/del-attr/{{ $attr->id }}"><i class="fas fa-times"></i></a>
							...
							<div class="col-md-10 widget-right boxattr">
								...
								<div class="text-attr">{{ $value->value }} 
									...
									<a onclick="return del_value('{{ $value->value }}')" href="admin/product/del-value/{{ $value->id }}" class="del-value"><i class="fas fa-times"></i></a>
								</div>
								@endforeach
							</div>		
					</div>
...
@section('script')
	@parent
	<script>
		function del_attr(name)
		{
			return confirm('Bạn muốn xóa thuộc tính : '+name+' ? ')
		}

		function del_value(name)
		{
			return confirm('Bạn muốn xóa giá trị thuộc tính : '+name+' ? ')
		}
