		...
		<div class="row row-pb-md">
			<div class="col-md-10 col-md-offset-1">
				...
				<div class="product-cart">
					...
					<div class="one-eight text-center">
						<div class="display-tc">
							<input onchange="update('{{ $product->rowId }}',this.value)" type="number" id="quantity" name="quantity" class="form-control input-number text-center" value="{{ $product->qty }}">
						</div>
					</div>
					<div class="one-eight text-center">
						<div class="display-tc">
					...
					<div class="one-eight text-center">
						<div class="display-tc">
							<a onclick="return del_cart()" href="/product/removecart/{{ $product->rowId }}" class="closed"></a>
						</div>
					</div>
				</div>
				@endforeach
