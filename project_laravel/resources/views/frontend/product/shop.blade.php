                    ...
                    <div class="col-md-4 text-center">
                        <div class="product-entry">
                            <div class="product-img" style="background-image: url(../backend/img/{{$product->img}});">
                                ...
                                <div class="cart">
                                    <p>
                                        <span class="addtocart"><a href="/k86/project-3-k86/blog/public/product/detail/{{$product->id}}"><i class="icon-shopping-cart"></i></a></span>
                                        <span><a href="/k86/project-3-k86/blog/public/product/detail/{{$product->id}}"><i class="icon-eye"></i></a></span>

                                    </p>
                                </div>
                            </div>
                            <div class="desc">
                                <h3><a href="/k86/project-3-k86/blog/public/product/detail/{{$product->id}}">{{$product->name}}</a></h3>
                                        ...
                                        <div id="menu{{$cate->id}}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                                            <div class="panel-body">
                                                <ul>
                                                    ...
                                                    <li><a href="/k86/project-3-k86/blog/public/product?category={{$cate2->id}}">{{$cate2->name}}</a></li>
                                                    @endif
                                                    @endforeach
                            ...
                            <h2>{{$attr->name}}</h2>
                                <div class="size-wrap">
                                    <p class="size-desc">
                                        ...
                                        <a href="/k86/project-3-k86/blog/public/product?value={{$value->id}}" class="attr">{{$value->value}}</a>
                                        @endforeach
