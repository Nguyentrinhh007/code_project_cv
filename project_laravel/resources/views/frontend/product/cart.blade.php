            ...
            <div class="col-md-10 col-md-offset-1">
            	...
            	@foreach ($cart as $product)
						<div class="product-cart">
								...
								<div class="one-eight text-center">
									<div class="display-tc">
                                        <a onclick="return del_cart('{{$product->name}}')" href="/k86/project-3-k86/blog/public/product/removecart/{{$product->rowId}}" class="closed"></a>
									</div>
								</div>
							</div>
						@endforeach
                        ...
                        <div class="col-md-3 col-md-push-1 text-center">
                            <div class="total">
                                ...
                                <div class="grand-total">
                                    ...
                                    <a href="/k86/project-3-k86/blog/public/product/checkout" class="btn btn-primary">Thanh toán <i class="icon-arrow-right-circle"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script>
        ...
        {
            $.get('/k86/project-3-k86/blog/public/product/updatecart/'+rowId+'/'+qty,
            function()
            {
