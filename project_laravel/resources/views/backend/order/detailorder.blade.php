                    ...
                    <div class="bootstrap-table">
                        <div class="table-responsive">
                            ...
                            <table class="table table-bordered" style="margin-top:20px;">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{number_format($order->price*$order->quantity,0,'',',')}}VND</td>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <h4 align='right' style="color: brown;">{{number_format($customer->total,0,'',',')}}VND</h4>
                                        </th>
                            ...
                            <div class="alert alert-primary" role="alert" align='right'>
                                <a name="" id="" class="btn btn-success" href="/k86/project-3-k86/blog/public/admin/order/active/{{$customer->id}}" role="button">Đã xử lý</a>
                            </div>
                        </div>
                    </div>
