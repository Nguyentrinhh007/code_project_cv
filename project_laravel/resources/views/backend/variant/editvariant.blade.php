...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Sửa biến thể</h1>
        </div>
    </div>
    <!--/.row-->
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <form action="" method="post">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                <a onclick="return del_variant()" class="btn btn-warning" href="/k86/project-3-k86/blog/public/admin/product/del_variant/{{$variant->id}}" role="button">Xoá</a>
                                </td>
                            </tr>
                ...
                <div align='right'><button class="btn btn-success" type="submit"> Cập nhật </button> <a class="btn btn-warning"
                        href="/k86/project-3-k86/blog/public/admin/product" role="button">Bỏ qua</a></div>
                    </form>
        </div>
    </div>
